...
class ColourCategoryTaskIntro extends StatefulWidget {
  final Function onNext;
  final int patternMethod;
  ColourCategoryTaskIntro({this.onNext, this.patternMethod});

  @override
  _ColourCategoryTaskIntroState createState() => _ColourCategoryTaskIntroState();
}

class _ColourCategoryTaskIntroState extends State<ColourCategoryTaskIntro> {
  @override
                        ...
                        children: [
                          ...
                          ConstrainedBox(
                            constraints: BoxConstraints(
                              ...
                              child: StudySubTitle(
                                  title:
                                      "In this task you will be presented with ten colours, each with a corresponding category label. You will be required to determine the category that a separate colour swatch belongs to."),
                            ),
                          ),
                          //Spacer(),
                          //Expanded(
