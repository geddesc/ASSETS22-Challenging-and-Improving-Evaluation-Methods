...
class ColourDistinctionTaskIntro extends StatefulWidget {
  final Function onNext;
  final int patternMethod;
  ColourDistinctionTaskIntro({this.onNext, this.patternMethod});

  @override
  _ColourDistinctionTaskIntroState createState() => _ColourDistinctionTaskIntroState();
}

class _ColourDistinctionTaskIntroState extends State<ColourDistinctionTaskIntro> {
  @override
                        ...
                        children: [
                          ...
                          ConstrainedBox(
                            constraints: BoxConstraints(
                              ...
                              child: StudySubTitle(
                                  title:
                                      "In this task you will be presented with a grid of coloured squares from which you will be required to determine all the unique colour names that are within the grid by selecting them from the checkboxes at the bottom."),
                            ),
                          ),
                          //Spacer(),
                          //Expanded(
